...
module.exports = {
    data: new Discord.SlashCommandBuilder().setName('welcome-message').setDescription('tester le message de bienvenue dans le channel actuel').addUserOption(user => user.setName("utilisateur").setDescription('L\'utilisateur avec lequel tester').setRequired(true)).addBooleanOption(input => input.setName("dans_ce_channel").setDescription('Envoyer le message de bienvenue dans ce channel')),
    /**
    ...
    execute: (Client, interaction) => {
        ...
        interaction.reply("Le message de bienvenue a été envoyé !")
    }
}